    ...
    <nav> 
        ...
        <div class="menu">
            <ul>
                ...
                <li>
                    <a href="dangki.html" target="_self" class="login-link">Đăng Nhập</a>
                </li>
                <li><a href="index.html">Trang chủ</a></li>
                <li><a href="sanpham.html">Sản phẩm</a>
                <li><a href="FAQs.html">Event</a></li>
                <li><a href="FAQs.html">Thêm sản phẩm</a></li>
 ...
 <center class="center">
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
          <img src="images (1)/images/KM4.jpg" style="width:100%">
        </div>
      
      
        <div class="mySlides fade">
          <img src="images (1)/images/KM5.jpg" style="width:100%">
        </div>
      
        <div class="mySlides fade">
          <img src="images (1)/images/KM6.jpg" style="width:100%">
        </div>
